            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-12">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                            Chúng tôi luôn cập nhật xu hướng mới nhất và đảm bảo rằng bạn có những lựa chọn tuyệt vời để mua sắm.
                        </p>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">fb.com/datkingvn</span>
                                    </Link>
                                </li>
                ...
                <div className="mt-12 border-t border-gray-300 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 DatPay</p>
                    </div>
                </div>
            </div>
        </footer>
